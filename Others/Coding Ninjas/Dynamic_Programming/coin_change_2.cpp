...
int countWaysHelper(int denom[],int num,int n,int **output){
    if(n == 0){
        return 1;
    }
    //NO denominations
    ...
    int first = countWaysHelper(denom,num,n-denom[0],output);
    int second = countWaysHelper(denom+1,num-1,n,output);
...
int countWaysToMakeChange(int denominations[], int numDenominations, int value){
   ...
   */
    ...
    return countWaysHelper(denominations,numDenominations,value,output);
